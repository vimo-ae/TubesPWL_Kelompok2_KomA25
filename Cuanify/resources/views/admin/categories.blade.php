...
<div class="flex min-h-screen"
    ...
    <div class="flex-1 p-4 sm:p-6 lg:p-10 min-w-0">
        ...
        .alert-success { background:#dcfce7; color:#166534; border:1px solid #bbf7d0; border-radius:10px; padding:10px 16px; margin-bottom:16px; font-size:13px; font-weight:600; word-break:break-word; }
        .alert-error   { background:#fee2e2; color:#991b1b; border:1px solid #fecaca; border-radius:10px; padding:10px 16px; margin-bottom:16px; font-size:13px; font-weight:600; word-break:break-word; }
        ...
        .cat-table { width:100%; min-width:700px; border-collapse:collapse; font-size:13px;}
        ...
        .action-wrap { display:flex; gap:6px; justify-content:center; flex-wrap:wrap;}
        ...
        <div class="cat-wrap">
            ...
            <div class="relative overflow-hidden rounded-[24px] sm:rounded-[35px] bg-gradient-to-r from-[#b55fe6] via-[#df49a6] to-[#e84393] shadow-md min-h-[190px] flex items-center w-full mb-6">
                ...
                <div class="relative z-10 w-full flex flex-col justify-center px-5 sm:px-8 lg:px-10 py-6 sm:py-8 text-white">
                    ...
                    <p class="text-white/90 text-xs sm:text-[13px] max-w-4xl font-normal leading-relaxed">
