<x-app-layout>
    ...
    <div class="p-6 max-w-7xl mx-auto">
        ...
        <a href="{{ route('admin.dashboard') }}" class="inline-block mb-6 text-indigo-600 hover:text-indigo-800 font-medium transition-all">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="p-4 text-center">
                                @if($user->status === 'active')
                                    <span class="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold capitalize">Active</span>
                                @elseif($user->status === 'inactive')
                                    <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-xs font-bold capitalize">Inactive</span>
                                @else
                                    <span class="bg-red-100 text-red-700 px-3 py-1 rounded-full text-xs font-bold capitalize">Banned</span>
                                @endif
                            </td>
                            <td class="p-4 text-center">
