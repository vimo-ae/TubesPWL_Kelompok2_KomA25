<x-app-layout>
    ...
    <div class="p-6">
        ...
        <form action="{{ route('instructor.courses.update', $course->course_id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <textarea
                    name="description"
                    rows="4"
                    class="border p-2 w-full rounded-md">{{ old('description', $course->description) }}</textarea>
            </div>
