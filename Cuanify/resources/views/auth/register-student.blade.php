<x-guest-layout>
    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-[#f6f7fb] relative overflow-hidden px-4 py-10">
        ...
        <div class="relative z-10 w-full max-w-[420px] bg-white rounded-[2rem] shadow-xl p-5 sm:p-6 border border-gray-100">
            ...
            <div class="text-center mb-4 mt-10">
                ...
                <p class="text-gray-500 mt-2 text-sm sm:text-base">Mulai perjalanan cuanmu bersama Cuanify</p>
                <p class="text-sm text-gray-500 mt-2">#BelajarJadiCuan</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <button type="submit" class="w-full mt-7 py-2.5 rounded-xl bg-gradient-to-r from-[#7F00FF] to-[#A855F7] hover:from-[#6D00E6] hover:to-[#9333EA] text-white font-semibold hover:scale-[1.02] hover:shadow-[0_10px_30px_rgba(0,0,0,0.08)] transition duration-300">
                    Register
                </button>

                <p class="text-center text-sm text-gray-800 mt-6">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-purple-700 font-semibold hover:underline">Login</a>
                </p>
