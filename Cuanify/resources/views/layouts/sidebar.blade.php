...
@if(auth()->user()->role === 'admin')
    ...
    <div class="flex flex-col gap-3 mt-4">
        ...
        <a href="{{ route('admin.dashboard') }}"
           class="w-full flex items-center gap-4 px-5 py-4 rounded-3xl transition-all duration-300
    ...
    <div class="flex flex-col gap-3 mt-4">
        ...
        @if(auth()->user()->role === 'instructor')
            <a href="{{ route('instructor.courses.index') }}"
               ...
               {{ request()->routeIs('instructor.courses.*')
                ...
                <span class="text-[15px]">Course Saya</span>
            </a>
        ...
        <a href="{{ route('courses.index') }}"
           ...
           {{ request()->routeIs('courses.*')
            ...
            <span class="text-[15px]">Semua Course</span>
        </a>
