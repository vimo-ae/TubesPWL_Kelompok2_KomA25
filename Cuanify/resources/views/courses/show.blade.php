                                    ...
                                    <div class="bg-gray-100 border rounded-2xl p-5 opacity-75">
                                        ...
                                        @else
                                            <p class="text-amber-600 text-sm mt-2 font-medium">
                                                🔒 Hanya dapat diakses oleh siswa yang terdaftar.
                                            </p>
                                        @endif
                                    </div>
                        ...
                        @elseif(auth()->user()->role === 'instructor')
                            @if($isOwner)
                                <a href="{{ route('instructor.courses.show', $course->course_id) }}"
                                   class="block text-center bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white py-3 rounded-2xl font-bold shadow-lg transition-all duration-300 hover:-translate-y-1">
                                    Kelola Course (Pemilik)
                                </a>
                            @else
                                <div class="text-center bg-gray-100 text-gray-500 py-3 rounded-2xl font-bold text-sm border border-gray-200">
                                    🔒 Mode Pratinjau Instruktur
                                </div>
                            @endif
                        @endif
